...
def step_impl(context):
    context.browser.find_element_by_xpath('/html/body/header/div/div/div[2]/ul/li[3]').click()
    context.browser.find_element_by_xpath('/html/body/header/div/div/div[2]/ul/li[3]/div/div[2]/a').click()
